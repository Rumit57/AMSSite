...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="header">
				<h3 class="page-header">Fixed Miss punch Report</h3>
				<div class="row">
					<div class="col-md-12">
							...
							<form action="#" method="post">
								<div class="row">
									...
									<div class="col-md-12 ">
										<br>
										<center>
											<input type="submit" formaction="filter4"
												...
												<table id="table" data-toggle="table" data-pagination="true"
													...
													<thead>
														<tr>
															...
															<th data-field="name" data-editable="true">Employee
																Name</th>
															<th data-field="Phone" data-editable="true">Phone
																Number</th>
															<th data-field="punch_time" data-editable="true">Punch
																Time</th>
															<th data-field="reason" data-editable="true">Reason</th>
															<th data-field="fixed_by" data-editable="true">Fixed
																By</th>
														</tr>
													</thead>
													<tbody>
														<c:forEach items="${reportData}" var="missedPunchRecord"
															varStatus="theCount">
															<tr>
																<td>${theCount.count}</td>
																<td>${missedPunchRecord.employee.firstName}&nbsp;${missedPunchRecord.employee.lastName}</td>
																<td>${missedPunchRecord.employee.mobile}</td>
																<td>${missedPunchRecord.punchTimestamp}</td>
																<td>${missedPunchRecord.reason}</td>
																<td>${missedPunchRecord.fixedBy.firstName}&nbsp;${missedPunchRecord.fixedBy.lastName}</td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
