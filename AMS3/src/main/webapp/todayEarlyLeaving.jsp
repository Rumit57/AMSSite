														...
														<div role="document" class="modal-dialog">
															<div class="modal-content">
																<div class="modal-header">
																	<h3 style="width: 100%">
																		<center>Apply To Leave</center>
																	</h3>
																	<button type="button" class="close"
																		data-dismiss="modal">&times;</button>
																</div>
																<form action="addTodayEarlyLeaving" method="post">
																	<div class="modal-body">

																		<div class="form-group">
																			<label>Employee Name</label><br> <select
																				class='fstdropdown-select' required
																				name="employeeId" data-toggle="dropdown"
																				style="width: 100%">
																				<option value="0">--Select employee--</option>
																				<c:forEach items="${employeeData}"
																					var="employeedata">
																					<option value="${employeedata.objId}">${employeedata.firstName}&nbsp;${employeedata.lastName}</option>
																				</c:forEach>
																			</select>
																		</div>
