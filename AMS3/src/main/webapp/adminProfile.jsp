				...
				<div style="border-radius: 1.5rem" class="row">
					...
					<div class="col-md-12">
						<div class="sparkline13-list">
							<div class="row">
								<div class="col-md-4">
									<form action="updatePhotoAdmin" enctype="multipart/form-data"
										method="post">
										<div class="profile-img1">
											<img src="${url}${appuser1.profilePhoto}"
								...
								<div class="col-md-6">
									<div class="profile-head1">
										<h3 style="text-transform: uppercase;">${appuser1.firstName}
											${appuser1.lastName}</h3>
								...
								<div class="col-md-2">
									<input type="submit" class="profile-edit-btn1" onclick="edit()"
								...
								<div class="col-md-8">
									<div class="tab-content profile-tab1">
										<form action="adminProfileUpdate" method="post">
											<input type="hidden" readonly name="objId" id="user_id"
												value="${appuser1.objId}" />
											...
											<div class="row">
												...
												<div class="col-md-3">
													<input type="text" readonly class="form-control"
														name="fname" id="fname" value="${appuser1.firstName}" />
												</div>
												<div class="col-md-3">
													<input type="text" readonly class="form-control"
														name="lname" id="lname" value="${appuser1.lastName}" />
												</div>
											</div>
											<br>
											<div class="row">
												...
												<div class="col-md-6">
													<input type="email" readonly class="form-control"
														name="email" id="email" value="${appuser1.email}" />
												</div>
											</div>
											<br>
											<div class="row">
												...
												<div class="col-md-6">
													<input type="text" readonly class="form-control"
														name="phone" id="phone" value="${appuser1.mobile}" />
												</div>
											</div>
											<br>
											<div id="addressHide" class="row">
												...
												<div class="col-md-6">
													<input type="text" readonly class="form-control" name="add"
														id="add" value="${appuser1.address1} ${appuser1.address2}" />
												</div>
											</div>
											<div id="address1Show" style="display: none" class="row">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="add1"
														id="add1" value="${appuser1.address1}" />
												</div>
												<br>
											</div>
											...
											<div id="address2Show" style="display: none" class="row">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="add2"
														id="add2" value="${appuser1.address2}" />
												</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<input type="text" readonly class="form-control"
														name="gender" id="gender" value="${appuser1.gender}" />
												</div>
											</div>
											<br>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<input type="text" readonly class="form-control"
														name="city" id="city" value="${appuser1.city}" />
												</div>
											</div>
											<br>
											<div class="row">
												...
												<div class="col-md-6">
													<input type="text" readonly class="form-control"
														name="state" id="state" value="${appuser1.state}" />
												</div>
											</div>
											<br>
											<div class="row">
												...
												<div class="col-md-6">
													<input type="text" readonly class="form-control"
														name="country" id="country" value="${appuser1.country}" />
												</div>
											</div>
											<br>
											<div class="row">
