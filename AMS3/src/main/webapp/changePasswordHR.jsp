            ...
            <div class="sidebar-collapse">
                <div id="mySidebar" class="sidebar">
                    <ul class="nav" id="main-menu">
                        <li>
                            <a href="hrDashboard"><i class="fa fa-dashboard"></i> Dashboard</a>
                        </li>
                        <li>
                            ...
                            <div class="sparkline13-list">
                                ...
                                <form action="changePasswordSubmitHR" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="oldPass" value="${oldPass}" placeholder="Enter Old Password..." class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <label>New Password</label> 
                                        <input type="password" name="newPass" value="${newPass}" placeholder="Enter New Password..." class="form-control"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Confirm Password</label>
                                        <input type="password" name="newCPass" value="${newCPass}" placeholder="Enter Confirm Password..." class="form-control"/>
                                    </div>
                                    <c:if test="${success==1}">
